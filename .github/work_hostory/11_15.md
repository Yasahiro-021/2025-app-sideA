...
- [ ] `NodeWithPath`クラスの完成
  - （前日に済）Freezedによるイミュータブルなデータクラスとして実装
  - （前日に済）`path`フィールド(NodePath型)の追加
  - `copyWith`メソッドのテスト
...
- 実施内容:node_pathを実装
- コミットID: `a9b0a94858ae61ed4481116b9e0aef7609baec36`
- 備考: テストも作成済み
...
- エージェントはFreezedの記録が古く、freezed3.0の仕様に対応していない可能性があるため、手動での修正が必要になる場合がある。
