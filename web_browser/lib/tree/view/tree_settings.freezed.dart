...
/// エレメントの幅
 ...
 double get elementPadding;/// グループの余白
...
@override
int get hashCode => Object.hash(runtimeType,elementWidth,elementPadding,groupPadding,layerHeight,groupVerticalSpacing,minScale,maxScale);

@override
String toString() {
  return 'TreeSettings(elementWidth: $elementWidth, elementPadding: $elementPadding, groupPadding: $groupPadding, layerHeight: $layerHeight, groupVerticalSpacing: $groupVerticalSpacing, minScale: $minScale, maxScale: $maxScale)';
}
...
@useResult
$Res call({
 double elementWidth, double elementPadding, double groupPadding, double layerHeight, double groupVerticalSpacing, double minScale, double maxScale
});
...
/// Create a copy of TreeSettings
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? elementWidth = null,Object? elementPadding = null,Object? groupPadding = null,Object? layerHeight = null,Object? groupVerticalSpacing = null,Object? minScale = null,Object? maxScale = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( double elementWidth,  double elementPadding,  double groupPadding,  double layerHeight,  double groupVerticalSpacing,  double minScale,  double maxScale)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _TreeSettings() when $default != null:
return $default(_that.elementWidth,_that.elementPadding,_that.groupPadding,_that.layerHeight,_that.groupVerticalSpacing,_that.minScale,_that.maxScale);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( double elementWidth,  double elementPadding,  double groupPadding,  double layerHeight,  double groupVerticalSpacing,  double minScale,  double maxScale)  $default,) {final _that = this;
switch (_that) {
case _TreeSettings():
return $default(_that.elementWidth,_that.elementPadding,_that.groupPadding,_that.layerHeight,_that.groupVerticalSpacing,_that.minScale,_that.maxScale);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( double elementWidth,  double elementPadding,  double groupPadding,  double layerHeight,  double groupVerticalSpacing,  double minScale,  double maxScale)?  $default,) {final _that = this;
switch (_that) {
case _TreeSettings() when $default != null:
return $default(_that.elementWidth,_that.elementPadding,_that.groupPadding,_that.layerHeight,_that.groupVerticalSpacing,_that.minScale,_that.maxScale);case _:
  return null;
...
class _TreeSettings implements TreeSettings {
  const _TreeSettings({this.elementWidth = 100, this.elementPadding = 8, this.groupPadding = 10, this.layerHeight = 100, this.groupVerticalSpacing = 100, this.minScale = 0.1, this.maxScale = 5.0});
...
/// Create a copy of TreeSettings
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? elementWidth = null,Object? elementPadding = null,Object? groupPadding = null,Object? layerHeight = null,Object? groupVerticalSpacing = null,Object? minScale = null,Object? maxScale = null,}) {
