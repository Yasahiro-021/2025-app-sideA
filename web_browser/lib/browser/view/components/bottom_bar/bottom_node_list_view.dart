...
import 'package:web_browser/browser/view/components/bottom_bar/bottom_node_list_view_model.dart';
...
class BottomNodeListView extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final List<NodePath> bottomNodes = ref.watch(bottomNodeListViewModelProvider);
    ...
    return ListView.builder(
      ...
      itemBuilder: (context, index) {
        final pathes = bottomNodes[index];
        return ChildNodeView(nodePath: pathes);
      },
    );
  }
}
